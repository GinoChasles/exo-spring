...
insert into mois(name) values ('janvier');
insert into mois(name) values ('fev');
insert into mois(name) values ('mar');
insert into mois(name) values ('avr');
insert into mois(name) values ('mai');
insert into mois(name) values ('juin');
insert into mois(name) values ('juillet');
insert into mois(name) values ('aou');
insert into mois(name) values ('sep');
insert into mois(name) values ('oct');
insert into mois(name) values ('nov');
insert into mois(name) values ('dec');
